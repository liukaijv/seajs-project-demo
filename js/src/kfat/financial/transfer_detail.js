define(function(require, exports, module) {
    ...
    var publishserialno = $.kingdom.getUrlParameter('publishserialno');//获取参数id
	...
	var getProductList = function(page,pageSize){
        self._seajs_handlebars_ajax_action({
            ...
            selector: "#J_transferdetail,#J_baseInfo",//html中提供的id
            template: "kfat/financial/transfer_detail.handlebars,kfat/financial/bondsdetail_baseInfo.handlebars"//模板
        });
    }();
    //立即投资方法
    var doSubmit = function(){
        ...
        var param = {fundcode:fundcode,publishserialno:publishserialno,applicationamount:applicationamount};
        $.kingdom.doKoauthAPI('kingdom.kfat.set_trans_apply_order','V2.0',param,investCallback);
    }
    var investCallback = function(data){
        var data = data.kdjson;
        if(data.flag == '1'){
            $.kd.kdAlert('新增转让认购成功', function() {
